...
for ts, dates, title in zip([ts_A, ts_B], [zoom_plot_dates_A, zoom_plot_dates_B],
                    ['../figures/fig07a_velocity_timeseries_ice_stereographic_uv.jpg',
                     '../figures/figS1a_velocity_timeseries_ice_stereographic_uv.jpg']):
...
for dates, filename in zip([zoom_plot_dates_A, zoom_plot_dates_B, cusp_plot_dates], 
                               ['../figures/fig07b_snapshot_drift_and_wind.jpg',
                                '../figures/figS1b_snapshot_drift_and_wind.jpg',
...
# Fig 6: Velocity
merge_images(['../figures/fig07a_velocity_timeseries_ice_stereographic_uv.jpg',
              '../figures/fig07b_snapshot_drift_and_wind.jpg'],
             '../figures/fig07_velocity.jpg')

merge_images(['../figures/figS1a_velocity_timeseries_ice_stereographic_uv.jpg',
              '../figures/figS1b_snapshot_drift_and_wind.jpg'],
